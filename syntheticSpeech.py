...
# video_file = r'D:\PyCharmProfessional\PyCharm\Project\YuYinTiHuan\videoWithoutAudioEn1.mp4'
#
# # 设置字幕文件路径
# subtitle_file = r'D:\PyCharmProfessional\PyCharm\Project\YuYinTiHuan\chartOne.srt'
    ...
    for i in range(len(segments)):
        # os.remove(f'en_audio_segment_{i}.wav')
        os.remove(f'{tmpname}{i}.wav')
        os.remove(f'{changeSpeedTmpname}{i}.wav')

    # 合并视频和音频
    subprocess.run(['ffmpeg', '-i', video_file, '-i', 'newOutputEn.wav', '-c', 'copy', output_path])
